...
dragonindexpage += '<style>html{max-height:100%;max-width:100%;}*{text-align:center;margin-top:1%;background-color:black;color:#fff;}</style><div class="justify-content-center"><h1>"Dragon-Ring Web Framework"</h1><br/><img width="300px" height="300px" src="website/brand.png" /><p>Created Date:- 23,Oct. 2021</p><p>Latest Update Date:- 12,Nov. 2021</p><p>By :-Mohannad Al-Dulaimi</p><br/>contact me on E-mail :- <a href="mailto:dragon-ring@hi2.in">dragon-ring@hi2.in</a><br/>(Alpha Version 1.0.2)</div></body></html>'
